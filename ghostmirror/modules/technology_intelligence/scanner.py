"""Standard scanner wrapper for the Technology Intelligence Module."""
...
class TechnologyIntelligenceScanner(ScannerBase):
    """Wrapper that runs local technology analysis and risk profiling within the standard scanner framework."""

    SCANNER_NAME = "technology_intelligence"
    ...
    def __init__(
        ...
        self.engine = TechnologyIntelligenceEngine(knowledge_dir=knowledge_dir)
    ...
    def get_metadata(self) -> dict[str, Any]:
        ...
        return {
            ...
            "description": "Technology Threat Intelligence, Attack Surface Analyzer, and Risk Profiler",
        }

    def run(self) -> ScanResultModel:
        """Runs local technology profiling and returns standard ScanResultModel.
        ...
        try:
            ...
            raise ScannerError(f"Erro ao executar a análise de tecnologia: {exc}") from exc
